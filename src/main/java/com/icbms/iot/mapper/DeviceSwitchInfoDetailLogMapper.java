...
public interface DeviceSwitchInfoDetailLogMapper {
    ...
    @Insert({
            ...
            "#{item.switchElectricA}, #{item.switchElectricB}, #{item.switchElectricC}, #{item.switchElectricN}, #{item.switchPowerA}, #{item.switchPowerB}, #{item.switchPowerC}, #{item.createTime}, #{item.updateTime}, #{item.remark})",
            "</foreach>",
            "</script>"
    })
